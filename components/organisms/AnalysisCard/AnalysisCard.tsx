...
import { Card, Divider } from '@/components/design-system/ui';
import { useTranslate } from "@/hooks/useTranslate";
import { useColorScheme } from "@/hooks/useColorScheme";
import { Colors } from "@/constants/Colors";
import { IAnalysisCard } from "@/types";

export const AnalysisCard: React.FC<IAnalysisCard> = ({ title, content}) => {
    ...
    return (
        <Card size={'sm'} variant='outline' style={styles.card}>
            <Text bold size={'md'} accessibilityLabel={title} style={styles.cardTitle}>{localize(title)}</Text>
