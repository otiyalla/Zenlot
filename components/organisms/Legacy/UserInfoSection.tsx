...
import { Icon, Text, TextInput, Button, Select } from '@/components/atoms';
import { useUser } from '@/providers/UserProvider';
import { useTranslate } from '@/hooks/useTranslate';
import { useColorScheme } from '@/hooks/useColorScheme';
import { Colors, languageOptions, LanguageOptionType, currencyOptions } from '@/constants';
        ...
        >
            ...
            <VStack space="md" style={styles.form}>
                ...
                <Select
                    ...
                    onValueChange={(value) => setFormData(prev => ({ ...prev, language: value as LanguageOptionType }))}
                />
                </View>
